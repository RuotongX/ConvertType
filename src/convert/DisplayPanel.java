...
public class DisplayPanel extends JPanel{
	...
	public DisplayPanel() {
		...
		this.title = new JLabel("Suffix replacer");
		...
		this.input = new JLabel("Please input your target path:");
		this.input.setLocation(50,250);
		this.input.setSize(350,50);
		this.input.setFont(new Font("Arial",1,25));
		this.input.setVisible(true);
		this.add(this.input);
		
		this.inputsuffix = new JLabel("Please input your original suffix:");
		this.inputsuffix.setLocation(50,350);
		this.inputsuffix.setSize(450,50);
		this.inputsuffix.setFont(new Font("Arial",1,25));
